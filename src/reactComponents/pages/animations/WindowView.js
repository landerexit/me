...
const WindowView = inject()(
    observer(() => {
        ...
        const predictions = [ 
            ...
            'Пусть мир наполнится спокойствием и доброжелательностью.','Слушайте каждого. Идеи приходят отовсюду.','Тот, кто не ждет благодарности, никогда не будет разочарован.','Удача проводит Вас через все трудные времена.',
